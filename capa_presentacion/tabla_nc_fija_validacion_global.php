...
if ($tienda==='TODO') {
 ...
 ncf.subtipo, ncf.descripcion , ncf.ejecutivo_telefonica, ncf.estado,ncf.validacion,s.nombre
 from nc_fija as ncf left join supervisor as s on s.id_supervisor=ncf.id_supervisor
