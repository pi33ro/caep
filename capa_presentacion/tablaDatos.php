...
$sqldatos = "SELECT  d.ruc,d.razon_social,d.zonal,d.nodo,d.origen,d.tipo_data from datos as d where d.id_usuario='$idusu' and d.id_tienda='$tienda' and d.estado='0' and d.tipo_data='MOVIL' LIMIT 50";
