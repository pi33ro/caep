...
if ($ncestado === 'XINGRESAR' || $ncestado === 'PENDIENTE' || $ncestado === 'AGENDADO' || $ncestado === 'OBSERVADO' ||   $ncestado === 'INICIADO' || $ncestado === 'BOLSA') {
 ...
 from nc_fija as ncf left join usuario as u on u.id_usuario=ncf.id_usuario
where  year(ncf.fecha_validacion)<='$ano' and ncf.estado=
'$ncestado'  and ncf.zonal='$tienda'
...
ncf.estado in ('XINGRESAR','PENDIENTE','AGENDADO','OBSERVADO','INICIADO','BOLSA')  and ncf.zonal='$tienda'
...
SELECT ncf.id_cargo,ncf.fecha_ingreso, ncf.ruc,ncf.razon_social,ncf.modalidad,
 ...
 from nc_fija as ncf left join usuario as u on u.id_usuario=ncf.id_usuario
where month(ncf.fecha_liquidacion)='$periodo' and year(ncf.fecha_liquidacion)='$ano' and ncf.estado=
'COMPLETADO'   and ncf.zonal='$tienda'
...
SELECT ncf.id_cargo,ncf.fecha_ingreso, ncf.ruc,ncf.razon_social,ncf.modalidad,
 ...
 from nc_fija as ncf left join usuario as u on u.id_usuario=ncf.id_usuario
where month(ncf.fecha_validacion)='$periodo' and year(ncf.fecha_validacion)='$ano' and ncf.estado=
'CANCELADO'   and ncf.zonal='$tienda'
