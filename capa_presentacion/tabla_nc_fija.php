...
if (
    $estado === 'OBSERVADO' || $estado === 'PENDIENTE' || $estado === 'XINGRESAR' || $estado === 'AGENDADO' ||
    $estado === 'INICIADO' || $estado === 'BOLSA' || $estado === 'ADR'
) {
...
ORDER BY ncf.fecha_ingreso DESC";
 ...
 from nc_fija as ncf 
where  year(ncf.fecha_ingreso)='$ano' and 
ncf.id_usuario='$idusu' and ncf.estado in ('OBSERVADO','PENDIENTE','XINGRESAR','AGENDADO','INICIADO','BOLSA','ADR') 
...
SELECT ncf.id_cargo,ncf.fecha_ingreso, ncf.ruc,ncf.razon_social,ncf.modalidad,
 ...
 from nc_fija as ncf 
where month(ncf.fecha_liquidacion)='$periodo' and year(ncf.fecha_liquidacion)='$ano' and 
ncf.id_usuario='$idusu' and ncf.estado='COMPLETADO'
...
SELECT ncf.id_cargo,ncf.fecha_ingreso, ncf.ruc,ncf.razon_social,ncf.modalidad,
 ...
 from nc_fija as ncf 
where month(ncf.fecha_ingreso)='$periodo' and year(ncf.fecha_ingreso)='$ano' and 
ncf.id_usuario='$idusu' and ncf.estado='CANCELADO'
";
        }
    }
}
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="text-align: center;">
                                <span class="btn btn-success btn-sm" data-toggle="modal" data-target="#modalSeguimiento"
