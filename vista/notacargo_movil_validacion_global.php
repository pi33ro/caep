    ...
    <body class="skin-blue">
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <form class="form form-horizontal" id='frmrepexportarvalidacionmovil' action="../procesos/repexportarvalidacionmovilglobal.php" method="post">
        ...
        <script type="text/javascript" src="js/notacargo_movil_validacion_global.js"></script>
