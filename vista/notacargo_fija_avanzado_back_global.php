  ...
  <body class="skin-blue">
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        <div class="col-lg-12" style="background-color: #615ca8;color: white; font-weight: bold;text-align: center ">SEGUIMIENTO NOTA DE CARGO FIJA AVANZADO</div>


        </br>
        <form class="form form-horizontal" id='frmrepexportarback' action="../procesos/repexportarbackavanzadoglobal.php" method="post">
                  ...
                  <form id="frmNCFB" method="post">
                    ...
                    <div id="nuevocliente" style="display:show">
                      ...
                      <div class="row">
                        ...
                        <div class="col-xs-4">
                          <label>Mes de Emisi&oacute;n</label>

                          <select name="ncmesf" class="form-control" id='ncmesf'>
    ...
    <script type="text/javascript" src="js/notacargo_fija_avanzado_back_global.js"></script>
