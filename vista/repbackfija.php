  ...
  <body class="skin-blue">
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        <div class="col-lg-12" style="background-color: #dc3545;color: white; font-weight: bold;text-align: center ">REPORTE NOTA DE CARGO FIJA TRADICIONAL</div>


        </br>
        <form class="form form-horizontal" id='frmrepexportarback' action="../procesos/repexportarback.php" method="post">
                  ...
                  <form id="frmNCFB" method="post">
                    <div class="row">
                      ...
                      <div class="col-xs-4">
                        ...
                        <input type="text" class="form-control input-sm" id="ncpeticion" name="ncpeticion" disabled="">
    ...
    <script type="text/javascript" src="js/repbackfija.js"></script>
