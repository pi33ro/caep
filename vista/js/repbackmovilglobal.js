...
$('#tablaDatatable').load('../capa_presentacion/tabla_repbackmovilglobal.php?ano='+ano+'&periodo='+periodo+'&ncestadof='+ncestadof+'&tienda='+tienda+'&ncvalidacionf='+ncvalidacionf);
