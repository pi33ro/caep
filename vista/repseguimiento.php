...
<div  class="col-lg-12"  style="background-color: #00a65a;color: white; font-weight: bold;text-align: center ">REPORTE GESTION SUPERVISORES</div> </br>
             ...
             <input type="hidden"  class="form-control input-sm" id="idusu" name="idusu" value="<?php echo $idusu ?>">
                                        ...
                                        <ol class="breadcrumb">                                            
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-2">                                                           
                                                    <button type="button" class="btn btn-success" id="excel">EXPORTAR</button>                                                                
                                                </div>
...
<div id="tablaDatatable"></div> 
                                        ...
                                        <script type="text/javascript" src="js/repseguimiento.js"></script>
