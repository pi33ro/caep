                                    ...
                                    <form id="frmNCFB" method="post">
                                        <div class="row">
                                            ...
                                            <div class="col-xs-4">
                                                ...
                                                <input type="text" disabled="" class="form-control input-sm" id="ncpeticion" name="ncpeticion">
                                            </div>
                                            <div class="col-xs-4">
                                                <label>Contrata</label>
                                                <input type="text" disabled="" class="form-control input-sm" id="nccontrata" name="nccontrata">
                                            </div>
                                        </div>
                                        <!--- div para elegir el tipo de respuesta-->
                                        <div id="nuevocliente" style="display:show">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xs-4">
                                                    ...
                                                    <select disabled="" name="ncestado" class="form-control" id='ncestado'>
                                                        <option value="XINGRESAR">XINGRESAR</option>
                                                        <option value="PENDIENTE">PENDIENTE</option>
                                            ...
                                            <div class="row">
                                                <div class="col-xs-6">
                                                    ...
                                                    <input type="text" disabled="" class="form-control input-sm" id="ncnunasignado" name="ncnunasignado">
                                                </div>
                                                <div class="col-xs-6">
                                                    <label>Caso SF</label>
                                                    <input type="text" disabled="" class="form-control input-sm" id="nccasosf" name="nccasosf">
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-xs-4">
                                        ...
                                        <div id="comun" style="display:show">
                                            ...
                                            <div class="row">
                                                <div class="col-xs-12">
                                                    ...
                                                    <div class="form-group">
                                                        <textarea class="form-control" disabled="" rows="10" id="nccomentarioback" name="nccomentarioback"></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
