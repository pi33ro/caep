...
<div  class="col-lg-12"  style="background-color: #615ca8;color: white; font-weight: bold;text-align: center ">VALIDACION NOTA DE CARGO FIJA AVANZADO</div>


</br>
 <form class="form form-horizontal" id='frmrepexportarvalidacion' action="../procesos/repexportarvalidacionavanzadoglobal.php" method="post">
                                        ...
                                        <ol class="breadcrumb">                                            
                                            <div class="form-group">
                                                ...
                                                <div class="col-xs-2">
                                                  ...
                                                  <option value="CONOTE" >CON OTE</option>
                                                  <option value="SISEGO" >PND DE COTIZAR SISEGO</option>
                                                  <option value="OPORTUNIDAD" >PND DE OPORTUNIDAD</option>
                                                ...
                                                <div class="col-xs-2">
                                                  ...
                                                  <select name="ncregionf" class="form-control" 
                                                  id='ncregionf'>
...
<div  class="col-lg-12"  style="background-color: #dc3545;color: white; font-weight: bold;text-align: center ">VALIDACION NOTA DE CARGO FIJA AVANZADO</div>
...
<button type="button" class="btn btn-warning" id="btnRegistrar" >Registrar</button>
                                        ...
                                        <script type="text/javascript" src="js/notacargo_fija_avanzado_validacion_global.js"></script>
