...
<![endif]-->
    ...
    <body class="skin-blue">
                                        ...
                                        <div id="nuevocliente" style="display:show">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xs-8">
                                                    ...
                                                    <input type="text" class="form-control input-sm" id="ncejecutivotdp" name="ncejecutivotdp" required>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-xs-8">
        ...
        <script type="text/javascript" src="js/notacargo_fija_back.js"></script>
