...
?>
        ...
        <div class="content-wrapper">
            <div class="col-lg-12"
                style="background-color: #00a65a;color: white; font-weight: bold;text-align: center ">FUNNEL GESTION
                MOVIL</div>
        ...
        <div class="modal fade" id="modalEditar" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel "
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div id="datos" class="col-lg-12" style=" text-align: center "></div>



                    <ul class="nav nav-tabs">
                        <li class="active"><a href="#llamada" data-toggle="tab">GESTION</a></li>
                            ...
                            <div class="modal-body">
                                <form id="frmLlamada" method="post">
                                    ...
                                    <div class="row">
                                        ...
                                        <input type="hidden" class="form-control input-sm" id="razon_social"
                                            name="razon_social">
                                        <input type="hidden" class="form-control input-sm" id="telcli" name="telcli">

                                        <input type="hidden" class="form-control input-sm" id="tienda" name="tienda"
                                            value="<?php echo $tienda ?>">
                                        <input type="hidden" class="form-control input-sm" id="fechahoy" name="fechahoy"
            ...
            echo $hoy ?>">
                                        ...
                                        <div class="col-xs-4">
                                            ...
                                            <input type="number" class="form-control input-sm" id="telefono"
                                    ...
                                    <div id="titular" style="display:none">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xs-4">
                                                ...
                                                <input type="number" class="form-control input-sm" id="qlineas"
                                                    name="qlineas" required>
                                            ...
                                            <div class="col-xs-8">
                                                ...
                                                <input type="text" class="form-control input-sm" id="nomcontacto"
                                                    name="nomcontacto">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xs-12">
                                                <label>Correo</label>
                                                <input type="email" class="form-control input-sm" id="correorl"
                                                    name="correorl">
                                    ...
                                    <div id="comun" style="display:none">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xs-4">
                                                <label>Q Claro</label>
                                                <input type="number" class="form-control input-sm" id="qclaro"
                                                    name="qclaro" required>

                                            </div>

                                            <div class="col-xs-4">
                                                <label>Q Entel</label>
                                                <input type="number" class="form-control input-sm" id="qentel"
                                                    name="qentel" required>

                                            </div>
                                            <div class="col-xs-4">
                                                <label>Q Bitel</label>
                                                <input type="number" class="form-control input-sm" id="qbitel"
                                                    name="qbitel" required>
                            ...
                            <div class="modal-footer" id="botones">
                                ...
                                <button type="button" class="btn btn-warning" id="btnRegistrar"
