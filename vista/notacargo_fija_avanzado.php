    ...
    <body class="skin-blue">
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                <div class="col-lg-12" style="background-color: #615ca8;color: white; font-weight: bold;text-align: center ">NOTA DE CARGO FIJA AVANZADO</div>
                                ...
                                <div class="modal-body">
                                    <form id="frmNCF" method="post">
                                        <div class="row">
                                            ...
                                            <div class="col-xs-4">
                                                <label>BACK</label>
                                                <select name="ncback" class="form-control" id='ncback'>
                                        ...
                                        <div id="nuevocliente" style="display:show">
                                            ...
                                            <div class="row">
                                                <div class="col-xs-4">
                                                    ...
                                                    <input type="text" disabled="" class="form-control input-sm" id="ncoportunidads" name="ncoportunidads">
                                                </div>
                                            </div>
        ...
        <script type="text/javascript" src="js/notacargo_fija_avanzado.js"></script>
