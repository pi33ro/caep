  ...
  <body class="skin-blue">
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <form class="form form-horizontal" id='frmrepexportarback' action="../procesos/repexportarmovilback.php" method="post">
    ...
    <script type="text/javascript" src="js/notacargo_movil_back.js"></script>
